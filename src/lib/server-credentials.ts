...
// NO lo compartas ni lo expongas en el lado del cliente.
// Está diseñado para ser usado únicamente en el entorno del servidor (Server Actions, flujos de Genkit).
